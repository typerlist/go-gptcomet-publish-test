...
try {
    # Get latest version
    $LatestRelease = Invoke-RestMethod -Uri "https://api.github.com/repos/belingud/go-gptcomet/releases/latest"
    ...
    $DownloadUrl = "https://github.com/belingud/go-gptcomet/releases/download/$Tag/gptcomet_${Version}_windows_$Arch.zip"
