...
# Get latest version
LATEST_VERSION=$(curl -s https://api.github.com/repos/belingud/go-gptcomet/releases/latest | grep tag_name | cut -d'"' -f4)
VERSION=${LATEST_VERSION#v}  # Remove 'v' prefix

# Build download URL based on OS and architecture
echo "Detected: $OS $ARCH"
DOWNLOAD_URL="https://github.com/belingud/go-gptcomet/releases/download/${LATEST_VERSION}/gptcomet_${VERSION}_${OS}_${ARCH}.tar.gz"
